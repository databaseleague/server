...
bool TPOOL_SUPPRESS_TSAN group_commit_lock::locked() { return m_lock; }

bool TPOOL_SUPPRESS_TSAN group_commit_lock::is_owner()
{
...
bool TPOOL_SUPPRESS_TSAN group_commit_lock::has_owner()
{
